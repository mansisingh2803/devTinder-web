...
const EditProfile = ({ user }) => {
  ...
  const [bio, setAbout] = useState(user.bio);
  ...
  return (
    <>
      <div className="flex justify-center  my-10 max ">
          ...
          <div className="card bg-base-300 w-96 shadow-xl">
            <div className="card-body">
              ...
              <div>
                ...
                <label className="form-control flex w-full max-w-xs my-2">
                  <div className="label">
                  ...
                  <div className="dropdown mx-2 my-1">
                    ...
                    <li>
                        <button type="button" onClick={() => setGender("Others")}>Others</button>
                    </li>
                    </ul>
                  </div>
                </label>
        ...
        <UserCard
          user={{ firstName, lastName, photoUrl, bio, age, gender , skills }}
        />
      </div>
      {showToast && (
